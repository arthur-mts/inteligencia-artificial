...
class Grafo:
    ...
    @staticmethod
    def __primeiro_vertice_aresta(a: str):
        '''
    ...
    @staticmethod
    def __segundo_vertice_aresta(a: str):
        '''
    ...
    def adicionaAresta(self, a, d):
        """
        Adiciona uma aresta ao grafo no formato X-Y, onde X é o primeiro vértice e Y é o segundo vértice
        :param a: a aresta no formato correto
        :param d: a distancia entre os dois vertices
        ...
        if self.vertice_valido(v):
            ...
            for i in range(len(self.N)):
                if self.M[index_V][i] != 0:  # linha
                    arestas.append({
                        "dist": self.M[index_V][i],
                        "value": self.N[i]
                    })
                elif self.M[i][index_V] != 0 and i != index_V:  # coluna
                    arestas.append({
